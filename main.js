function DQH() {
	...
	this.loadContent = function() {
		this.background = this.createObject("/DQH-Postcompo/imgs/worlds_background.png");
	...
	this.createZombie = function(x, y) {
		var zombie = this.createObject("/DQH-Postcompo/imgs/zombie.png", DQHType.Zombie);
		zombie.position(x, y);
	...
	this.createHolyBook = function(x, y) {
		var holyBook = this.createObject("/DQH-Postcompo/imgs/book.png", DQHType.Book);
	...
	this.createDruid = function(x, y) {
		var druid = this.createObject("/DQH-Postcompo/imgs/druid.png", DQHType.Druid);
		druid.position(x, y);
	...
	this.createFighter = function(x, y) {
		var fighter = this.createObject("/DQH-Postcompo/imgs/fighter.png", DQHType.Fighter);
